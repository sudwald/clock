    ...
    <div className="App">
      ...
      <main className="App-main">
        <div id='info'>
          ...
          <h2>How to play</h2>
            <ul>
              <li>Start by clicking the top-most card in the middle. It will jump to the right point on the 'clock' - with aces at 1 o' clock, then 2 o'clock, 3 o'clock, and so on.</li>
              <li>Turn over the top-most card on that point of the clock. That card will jump to <i>its</i> own point on the 'clock'.</li>
              ...
              <li>If you return all the cards to their correct position on the clock, you win! :)</li>
